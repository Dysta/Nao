...
public class Constant
{
	...
	//Server
	public static final String EMU_VERSION	=	"0.6";
	//Versions
	...
	//FIGHT
	public static final int TIME_BY_TURN			= 45*1000;
	...
	//Items
		...
		//Bonbons
		public static final int ITEM_POS_CANDY     = 20;
		public static final int ITEM_POS_CANDY1     = 21;
		public static final int ITEM_POS_CANDY2     = 22;
		public static final int ITEM_POS_CANDY3     = 23;
		public static final int ITEM_POS_CANDY4     = 24;
		public static final int ITEM_POS_CANDY5     = 25;
		public static final int ITEM_POS_CANDY6     = 26;
		public static final int ITEM_POS_CANDY7     = 27;
		
		public static int getAvailableCandyPos(Characters p)
		{					
			if(p.getObjetByPos(ITEM_POS_CANDY) == null)
				return ITEM_POS_CANDY;
			else if(p.getObjetByPos(ITEM_POS_CANDY1) == null)
				return ITEM_POS_CANDY1;
			else if(p.getObjetByPos(ITEM_POS_CANDY2) == null)
				return ITEM_POS_CANDY2;
			else if(p.getObjetByPos(ITEM_POS_CANDY3) == null)
				return ITEM_POS_CANDY3;
			else if(p.getObjetByPos(ITEM_POS_CANDY4) == null)
				return ITEM_POS_CANDY4;
			else if(p.getObjetByPos(ITEM_POS_CANDY5) == null)
				return ITEM_POS_CANDY5;
			else if(p.getObjetByPos(ITEM_POS_CANDY6) == null)
				return ITEM_POS_CANDY6;
			else if(p.getObjetByPos(ITEM_POS_CANDY7) == null)
				return ITEM_POS_CANDY7;
	...
	{
		{699,Constant.ETAT_SAOUL},
		{690,Constant.ETAT_SAOUL}
	};
	...
	//ITEMS de classe
	public static final int STATS_BOOST_SPELL_RANGE			=	281;
	public static final int STATS_BOOST_SPELL_RANGEABLE		=	282;
	public static final int STATS_BOOST_SPELL_DMG			=	283;
	public static final int STATS_BOOST_SPELL_HEAL			=	284;
	public static final int STATS_BOOST_SPELL_AP_COST		=	285;
	public static final int STATS_BOOST_SPELL_CAST_INTVL	=	286;
	public static final int STATS_BOOST_SPELL_CC			=	287;
	public static final int STATS_BOOST_SPELL_CASTOUTLINE	=	288;
	public static final int STATS_BOOST_SPELL_NOLINEOFSIGHT	=	289;
	public static final int STATS_BOOST_SPELL_MAXPERTURN	=	290;
	...
	public static String HUNT_ZATOISHWAN_DOC = "98_0706251211";  // ZatoÃ¯shwan
	public static String HUNT_LETHALINE_DOC  = "65_0706251123";  // LÃ©thaline Sigisbul
	...
	public static boolean isSpellStat(int stat_id)
	{
		if(stat_id >= 281 && stat_id <= 294) return true;
		return false;
	}
	...
	public static short getStartMap(int id)
	{
		...
		{
			return Config.CONFIG_START_MAP;
		}
		return pos;
	}
	...
	public static int getStartCell(int id)
	{
		...
		if(Config.CONFIG_CUSTOM_STARTMAP)
		{
			return Config.CONFIG_START_CELL;
		}
return pos;
}
	...
	public static boolean isValidPlaceForItem(ObjTemplate template, int place)
	{
		...
		switch(template.getType())
		{
			...
			//Barre d'objets TODO : Normalement le org.walaka.rubrumsolem.client bloque les items interdits
	...
	public static void onLevelUpSpells(Characters perso,int lvl)
	{
	...
	public static int getObjectPosByType(int type) 
	{
		int pos = -1;
		switch (type)
		{
	...
	public static Stats getMountStats(int color,int lvl)
	{
		...
		switch(color)
		{
			...
			//Squelette
			case 75 :
			stats.addOneStat(STATS_ADD_VITA, (int)(lvl*3));
			stats.addOneStat(STATS_ADD_SAGE, (int)(lvl/2.5));
			stats.addOneStat(STATS_ADD_FORC, (int)(lvl/1.25));
			stats.addOneStat(STATS_ADD_INTE, (int)(lvl/1.25));
			stats.addOneStat(STATS_ADD_CHAN, (int)(lvl/1.25));
			stats.addOneStat(STATS_ADD_AGIL, (int)(lvl/1.25));
			break;
		}
		return stats;
	}
	...
	public static void applyPlotIOAction(Characters perso,int mID, int cID)
	{
		...
		case 2196://Création de guilde
			...
			if(perso.get_compte().get_subscriber() == 0 && Config.USE_SUBSCRIBE)
			{
				SocketManager.PERSO_SEND_EXCHANGE_REQUEST_ERROR(perso,'S');
				return;
			}
		...
		break;
		default:
			Logs.addToGameLog("PlotIOAction non gere pour la map "+mID+" cell="+cID);
		}
	}
	
	public static int getNearCellidUnused(Characters _perso)
	{
		int cellFront = 0;
		int cellBack = 0;
		int cellRight = 0;
		int cellLeft = 0;
		if(_perso.get_curCarte().getSubArea().getArea().getID() == 7 || _perso.get_curCarte().getSubArea().getArea().getID() == 11)
		{
			cellFront = 19;
			cellBack = -19;
			cellRight = 18;
	...
	public static boolean getMapForbidden(short mapId)
	{
		switch(mapId)
		{
			case 1789:
