...
public class AuctionHouse {
	...
	public static class HdvEntry implements Comparable<HdvEntry>
	{
		...
		private Objects _obj;
		private int _ligneID;
		private int _owner;
		
		public HdvEntry(int price, byte amount, int owner, Objects obj)
		{
			this._price = price;
			this._amount = amount;
			this._obj = obj;
	...
	public AuctionHouse(int hdvID, float taxe, short sellTime, short maxItemCompte,short lvlMax, String categories)
	{
		this._hdvID = hdvID;
		this._taxe = taxe;
	...
	public synchronized boolean buyItem(int ligneID,byte amount, int price, Characters newOwner)
	{
